...
const mode_auth_1 = require("../modules/auth/mode.auth");
const auth = (...requiredRoles) => {
    return (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const user = yield mode_auth_1.User.isUserExists(email);
        if (!user) {
            throw new AppErrors_1.default(http_status_1.default.NOT_FOUND, 'This user is not found !', 'No user found with the id');
        }
