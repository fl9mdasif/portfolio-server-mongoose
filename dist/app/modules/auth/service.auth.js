...
const mode_auth_1 = require("./mode.auth");
...
const registerUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    // create
    const register = yield mode_auth_1.User.create(payload);
    return register;
});
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(yield mode_auth_1.User.isPasswordMatched(payload === null || payload === void 0 ? void 0 : payload.password, user === null || user === void 0 ? void 0 : user.password)))
...
const changePassword = (userData, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield mode_auth_1.User.isUserExists(userData.username);
    // console.log(user);
    if (!user) {
        throw new AppErrors_1.default(http_status_1.default.NOT_FOUND, 'This user is not found !', '');
    }
    // 02. checking if the password is correct
    if (!(yield mode_auth_1.User.isPasswordMatched(payload.currentPassword, user === null || user === void 0 ? void 0 : user.password)))
    ...
    // update password
    yield mode_auth_1.User.findOneAndUpdate({
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield mode_auth_1.User.isUserExists(username);
    // console.log(decoded);
    if (!user) {
        throw new AppErrors_1.default(http_status_1.default.NOT_FOUND, 'This user is not found !');
    }
    if (user.passwordChangedAt &&
        mode_auth_1.User.isJWTIssuedBeforePasswordChanged(user.passwordChangedAt, iat)) {
